function [fitness,totalError] = EvaluateIndividual(chromosome,dataset,nVariableRegisters,constantRegistersSet,divisionProtection,maximumLengthOfChromosome,lengthViolationPenalty)
