...
nearestNeighbourPathLength = NNPathLengthCalculator(cityLocation); % To do: Write the GetNearestNeighbourPathLength function
...
while (minimumPathLength > targetPathLength)
 ...
 for k = 1:numberOfAnts
  ...
  if (pathLength < minimumPathLength)
    ...
    title(sprintf('ACO paths, Pathlength: %.2f',minimumPathLength));
  end
